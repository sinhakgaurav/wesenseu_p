    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-indigo-50 to-white pt-20 pb-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4">About Monitour</h1>
          <p className="text-xl text-gray-600">
            We're on a mission to give every hospitality team the technology
            that was once reserved for global chains.
          </p>
        </div>
      </section>
